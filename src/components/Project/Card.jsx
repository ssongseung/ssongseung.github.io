        ...
        <div className="w-[220px] h-[329px] perspective-[900px]">
            ...
            >
                ...
                <div
                    ...
                    className={`w-full h-full rounded-[19px] border p-2 flex flex-col justify-between ${colorData[type]} backface-hidden transform-gpu`}
                >
                    {front(handleFlip)}
                </div>
                ...
                {/* back */}
                <div
                    className={`absolute inset-0 rounded-[19px] border p-2 flex flex-col justify-between ${colorData[type]} rotate-y-180 backface-hidden`}
                >
                    {back(handleFlip)}
                </div>
            </div>
