...
import Img2 from '../../assets/project08.png';
        ...
        <>
          <div>
            ...
            <div className='mt-[10px]'>
              <p className='text-[22px] md:text-[22px] text-black'>Role</p>
              <p className='text-[18px] text-black'>{role}</p>
            </div>
            <div className='mt-[10px]'>
              <p className='text-[22px] text-black'>Skills</p>
              <p className='text-[18px] text-black'>{skill}</p>
            </div>
          </div>
